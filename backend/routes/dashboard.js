...
router.get('/stats', async (req, res) => {
    try {
        ...
        // 5. NEW: Calculate Sales Analytics (Revenue & Orders)
        ...
        res.json({
            overview: {
                ...
                total_revenue: parseFloat(totalRevenue), // Added
                total_orders: parseInt(totalOrders)      // Added
            },
            metal_breakdown: metalStats,
            category_breakdown: categoryStatsRes.rows,
            recent_orders: recentOrdersRes.rows          // Added
        });
