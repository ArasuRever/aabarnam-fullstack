...
const Cart = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-gray-500 mb-8 max-w-md">Looks like you haven't found your perfect piece yet. Explore our collection of handcrafted jewelry.</p>
        <Link to="/" className="bg-black text-gold px-8 py-3 rounded-full font-bold hover:bg-gray-800 transition">
          Start Shopping
        </Link>
      </div>
    );
  ...
  // Calculate Tax (already included in price, but we show breakdown)
  const subtotal = cartTotal / 1.03; // Reverse calc for 3% GST
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="font-bold text-lg text-gray-900">
                        ₹{(parseFloat(item.price_breakdown?.final_total_price) * item.qty).toFixed(2)}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-end">
                     ...
                     <button 
                        ...
                        className="text-gray-400 hover:text-red-500 transition flex items-center gap-1 text-xs font-medium"
                     >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 sticky top-24">
              ...
              <div className="mt-4 flex justify-center gap-2">
                 <span className="text-[10px] text-gray-400 border border-gray-200 px-2 py-1 rounded">🔒 SSL Secure</span>
                 <span className="text-[10px] text-gray-400 border border-gray-200 px-2 py-1 rounded">🛡️ Insured</span>
              </div>
            </div>
          </div>
