...
const Auth = () => {
  ...
  // Updated state to hold Phone and Address details
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        await register(formData); // Sends the entire form data package
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 py-12 px-4 animate-fade-in">
